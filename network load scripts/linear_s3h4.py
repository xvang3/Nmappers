...
class SimpleTopo(Topo):
    def __init__(self, **opts):
        ...
        self.addLink(switch1, switch2)  # Added link between s1 and s2
...
def simpleTest():
    ...
    # Redirecting output to a text file named linear_s3_data.txt
    with open("linear_s3h4_data.txt", "w") as f:
